...
@XmlType(name = "PAYOUTUPDATE_STATUSType", propOrder = {
    "compensationstatus"
})
@XmlRootElement(name = "UPDATE_STATUS")
public class PAYOUTUPDATESTATUSType {

    @XmlElement(name = "COMPENSATION_STATUS")
    protected List<PAYOUTCOMPENSATIONSTATUSType> compensationstatus;
     ...
     * {@link com.mvp.java.xo.PAYOUTCOMPENSATIONSTATUSType }
     * 
     * 
     */
    public List<PAYOUTCOMPENSATIONSTATUSType> getCOMPENSATIONSTATUS() {
        if (compensationstatus == null) {
            compensationstatus = new ArrayList<PAYOUTCOMPENSATIONSTATUSType>();
        }
